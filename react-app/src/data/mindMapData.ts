...
export const mindMapData: MindMapNodeData = { id: 'root',
  ...
  type: 'root',
  color: '#6366F1',
  description: 'מפת מערכת Claude — פרויקטים, סוכנים, סקילים, MCP ומצבים',
  children: [
    { id: 'agents',
      name: 'סוכנים',
      type: 'folder',
      color: '#EF4444',
      description: '37 סוכנים מתמחים',
      children: [
        { id: 'agents-arch',
          ...
          children: [
            ...
            { id: 'ag-research_agent',
              name: 'research-agent',
              type: 'agent',
              color: '#6366F1',
              description: 'מחקר מרובה מקורות — ציון מקורות, זיהוי סתירות, ציון ביטחון'
            },
            { id: 'ag-task_router',
              name: 'task-router',
              type: 'agent',
              color: '#6366F1',
              description: 'סיווג ונתוב אוטומטי של משימות — Claude / Haiku / Gemma'
            },
          ]
        },
        { id: 'agents-review',
    ...
    { id: 'projects',
      ...
      type: 'folder',
      color: '#F59E0B',
      description: '12 פרויקטים',
      children: [
        { id: 'proj-1',  name: 'גלגל הרגשות', type: 'reference', color: '#10B981', description: 'ויזואליזציית רגשות | HTML/JS' },
        { id: 'proj-2',  name: 'חדשני',        type: 'reference', color: '#F59E0B', description: 'דסק מודיעין שוק יומי | Python + Cloudflare' },
        { id: 'proj-3',  name: 'התראות',       type: 'reference', color: '#3B82F6', description: 'מערכת התראות iPhone | ntfy.sh' },
        { id: 'proj-4',  name: 'שליטה מרחוק',  type: 'reference', color: '#3B82F6', description: 'גישה מרחוק למחשב הראשי | AnyDesk' },
        { id: 'proj-5',  name: 'סטיקר בוט',    type: 'reference', color: '#3B82F6', description: 'בוט ליצירת מדבקות | Node.js + Python' },
        { id: 'proj-6',  name: 'לינקי',         type: 'reference', color: '#0891B2', description: 'שלח כל דבר → טקסט | Python + Telegram' },
        { id: 'proj-7',  name: 'LCL TCS',       type: 'reference', color: '#94A3B8', description: 'אפליקציית TCS | Firebase + React' },
        { id: 'proj-8',  name: 'אבולוציה',      type: 'reference', color: '#6366F1', description: 'מפת מערכת ויזואלית | React + D3.js' },
        { id: 'proj-9',  name: 'קסם הידיעה',    type: 'reference', color: '#FBBF24', description: 'סצנת AABB + Canvas | HTML/JS + Gemini' },
        { id: 'proj-10', name: 'TmunoteAI',     type: 'reference', color: '#EC4899', description: 'אפליקציית תמונות AI | Flask + Pollinations' },
        { id: 'proj-11', name: 'פוקטי',         type: 'reference', color: '#10B981', description: 'יועץ Claude Code גלובלי | Python + Telegram' },
        { id: 'proj-12', name: 'לוח ניהול',     type: 'reference', color: '#8B5CF6', description: 'ציר זמן ויזואלי | Vercel + Python' },
      ]
    },
  ]
};
